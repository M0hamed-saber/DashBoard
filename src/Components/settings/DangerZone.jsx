...
export default function DangerZone() {
  return (
    ...
    >
        ...
        <p className='text-gray-300 mb-4'>Permanently delete your account and all of your contact</p>
        <button className='bg-red-600 hover:bg-red-700  text-white font-bold py-2 px-4 rounded-xl transition duration-200'>
            Delete Account
        </button>
    </motion.div>
  )
